...
const light = new THREE.HemisphereLight( 0xffffff, 0x080820, .05 )
scene.add( light )
...
const materialsun = new THREE.MeshStandardMaterial({map:texturesun,lightMap:texturesun})
